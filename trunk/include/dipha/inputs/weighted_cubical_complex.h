...
namespace dipha {
    namespace inputs {
        ...
        protected:
            ...
            // Format: file_types::DIPHA % file_types::WEIGHTED_CUBICAL_COMPLEX % num_vertices % max_dim % lattice_resolution_1 % ... % lattice_resolution_dim % value_1 % ... % value_num_vertices
