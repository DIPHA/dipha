...
namespace dipha {
    ...
    INSTANTIATE_TYPED_TEST_CASE_P( ExtrinsicFullRips, TestDualWeightedCellComplex, ExtrinsicFullRipsTest );
    ...
    INSTANTIATE_TYPED_TEST_CASE_P( IntrinsicFullRips, TestDualWeightedCellComplex, IntrinsicFullRipsTest );
#endif
